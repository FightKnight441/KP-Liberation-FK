...
KP_liberation_save_interval = 180;                                       // Interval in seconds for automatic save.
...
KP_liberation_cr_wounded_chance = 70;                                   // Chance (0-100) that there are wounded civilians right after capturing a sector.
...
KP_liberation_civinfo_max = 5400;                                      // Civil Informant maximum spawn time. (seconds)
...
KPLIB_transportConfigs = [
	...
	["CUP_I_T810_Unarmed_LDF", -6.5, [0,0.3,0.05], [0,-1.3,0.05], [0,-2.9,0.05]],
	...
	["rhs_gaz66_flat_vdv", -5, [0,0.25,-.05], [0,-1.4,-.05]],
	["rhs_gaz66o_flat_vdv", -5, [0,0.25,-.05], [0,-1.4,-.05]],
