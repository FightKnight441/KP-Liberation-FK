...
Respawn_truck_typename = "rhsusf_m113_usarmy_medical";   				// This is the mobile respawn (and medical) truck.
...
KP_liberation_air_vehicle_building = "rhs_p37";             // The building defined to unlock FOB air vehicle functionality.
...
light_vehicles = [
    ...
    ["rhsusf_m1025_w",75,0,75],                                        	// M1025A2
	...
	["rhsusf_m1165a1_gmv_m2_m240_socom_d",100,50,50],					// Hummer with two turrets
...
air_vehicles = [
    ["B_UAV_01_F",25,25,25],                                            // AR-2 Darter
    ["B_UAV_06_F",25,25,25],                                            // AL-6 Pelican (Cargo)
...
support_vehicles = [
	...
	["Land_Cargo40_blue_F",100,0,50]									// Large Blue Cargo cantainer
];
...
elite_vehicles = [
	...
	"C_IDAP_UAV_06_antimine_F",											// Demining drone
