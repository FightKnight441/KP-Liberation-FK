...
GRLIB_arsenal_items = [
	...
	// Vanilla Uniforms
	"Item_U_B_CBRN_Suit_01_MTP_F",									// CBRN MTP
	"Item_U_B_CombatUniform_mcam",									// Combat Fatigues (MTP)
	"Item_U_B_CombatUniform_mcam_tshirt",							// Combat Fatigues Tee (MTP)
	"Item_U_B_CombatUniform_mcam_vest",								// Recon Fatigues
	"Item_U_B_CombatUniform_mcam_worn",								// Worn Combat Fatigues
	...
	"H_Bandanna_mcamo",												// mtp headband
	"H_Bandanna_khk_hs",											// bandana headset
	"H_Bandanna_khk",												// bandana headset
	"H_Cap_tan_specops_US",											// mtp cap
	"H_MilCap_mcamo",												// mtp mil cap
	...
	"V_PlateCarrier1_rgr",											// Lite Plate Vanilla
	"V_PlateCarrierL_CTRG",											// ^^ but Brit Flag
	"V_PlateCarrierIAGL_oli",										// Large Plate Rig olive
	"V_PlateCarrierGL_mtp",											// ^^ Same but MTP
	"V_PlateCarrier2_rgr",											// Plate Rig
	"V_PlateCarrier2_wdl",											// ^^ same but woodland
	...
	"ACE_NVG_Wide_Black",                                           // NV Goggles (Wide)
...
GRLIB_arsenal_backpacks = [
	...
	"B_Bergen_mcamo_F",												// Bergen (mtp)
	"B_Carryall_mcamo",												// Carry-all (mtp)
	"B_Kitbag_mcamo",												// Kit bag (mtp)
	"B_RadioBag_01_mtp_F",											// radio bag (mtp)
	"B_TacticalPack_mcamo",											// Tac pack (mtp)
	"B_LegStrapBag_black_F", 										// Leg strap bag
